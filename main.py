...
window.geometry("400x300") # Устанавливаем начальный размер окна (ширина x высота)

# Методы для обработки введенных чисел
def add_numbers_gui():
    try:
        # Получим введенные числа
        num1 = float(entry1.get()) # перевод в тип данных с плавающей точкой
        num2 = float(entry2.get()) # перевод в тип данных с плавающей точкой
        result = num1 + num2 # присвоение переменной суммы двух переменных
